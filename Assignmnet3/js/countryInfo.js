...
function getCityCountryInfo() {
    ...
    //STEP 4: API call to get location details
        ...
        const googleMapsUrl = `https://maps.googleapis.com/maps/api/timezone/json?location=${lat},${lon}&timestamp=${timestamp}&key=${googleMapsAPIKey}`; // added lat and lon from the openWeatherUrl
        ...
        const exchangeRateUrl = `https://v6.exchangerate-api.com/v6/53535e11716700db95019d7d/latest/USD`
...
function chosenCountry (openWeatherDetails, googleMapsDetails, exchangeRateDetails){
    ...
    //For Testing...
    console.log(APIUrl);
    return APIUrl; //to return the items
}
